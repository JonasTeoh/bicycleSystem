          ...
          <div class="signup-form">
            ...
            <form method="POST" action="/register" class="register-form">
              ...
              <div class="form-group" style="margin-top: 0;">
                ...
                <input style="font-family:verdana;" id="password" type="password" placeholder= "Password"
              ...
              <div class="form-group">
                ...
                <label for="password-confirm"><i class="zmdi"></i></label>
              ...
              <div class="form-group form-button">
                <button type="submit" class="btn btn-l btn-primary"
                  style="border: black; padding: 10px 20px 10px 20px;">Register</button>
              </div>
            </form>
          </div>

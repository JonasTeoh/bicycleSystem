  ...
  <div class="content-wrapper" style="height: 100px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="">Supplier</h1>
          </div><!-- /.col -->
          <div class="col-sm-10">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="{{ url('/supplier/create') }}" class="btn btn-success btn-sm" title="Add New Item">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="action-buttons d-flex">
                            ...
                            <a href="{{ url('/supplier/' . $item->id) }}" title="View Supplier" class="mr-2">
                              <button class="btn btn-info btn-sm">
                                <i class="fa fa-eye" aria-hidden="true"></i> View
                              </button>
                            </a>
                            <a href="{{ url('/supplier/' . $item->id . '/edit') }}" title="Edit Supplier" class="mr-2">

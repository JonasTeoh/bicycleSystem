      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="card-body">
            ...
            <h5 class="card-text">Unit Price (RM): {{ $purchaseRecord->inventory->price }}</h5>
            <h5 class="card-text">Total Price (RM): {{ number_format($purchaseRecord->inventory->price * $purchaseRecord->quantity, 2) }}</h5>

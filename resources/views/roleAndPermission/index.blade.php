  ...
  <div class="content-wrapper1" style="height: 100px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="">Roles Info</h1>
          </div><!-- /.col -->
          <div class="col-sm-10">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="{{ url('/roleAndPermission/create') }}" class="btn btn-success btn-sm" title="Add New Role">
                  ...
                  <tbody>
                    ...
                    @foreach ($roles as $item)
                      <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        {{-- <td>
                        @if (!empty($item->permissions->pluck('name')))
                          @foreach ($item->permissions->pluck('name') as $val)
                        ...
                        <td>
                          <div class="action-buttons d-flex">
                            ...
                            <a href="{{ url('/roleAndPermission/' . $item->id) }}" title="View Role" class="mr-2">
                            ...
                            <form method="POST" action="{{ url('/roleAndPermission' . '/' . $item->id) }}"

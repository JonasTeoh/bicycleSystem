      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ url('/customer/'.$customer->id) }}" >
            ...
            <input type="text" required name="contact_number" id="contact_number" class="form-control" value="{{ $customer->contact_number }}" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"><br>

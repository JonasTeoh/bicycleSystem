    ...
    <div class="container" style= "margin: left 50;">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Contact Number: {{ $customer->contact_number }}</p>
          <hr>
          ...
          <form method="POST" action="{{ url('/customer/'.$customer->id) }}" >
            ...
            <label>Name</label><br>
            <input type="text" required name="name" id="name" class="form-control" value="{{ $customer->name }}"><br>

            <label>Contact Number</label><br>
            <input type="number" required name="contact_number" id="contact_number" class="form-control" value="{{ $customer->contact_number }}" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"><br>

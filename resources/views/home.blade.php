          ...
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="d-flex justify-content-center">
                <div>
                  <h1 class="text-center">User Registrations</h1>
                  <div style="width:100%;">
                    <x-chartjs-component :chart="$userChart" />
                  </div>
                </div>
            ...
            <div class="row mt-3">
              <div class="d-flex justify-content-center">
                <div>
                  <h1 class="text-center">Purchase Records</h1>
                  <div style="width:100%;">
                    <x-chartjs-component :chart="$purchaseChart" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row mt-3">
              <div class="d-flex justify-content-center">
                <div>
                  ...
                  <div style="width:100%;">
                    <x-chartjs-component :chart="$itemChart" />
                  </div>
                </div>
              </div>
            </div>
            <div class="row mt-3">
              <div class="d-flex justify-content-center">
                <div>
                  <h1 class="text-center">Supply Records</h1>
                  <div style="width:100%;">
                    <x-chartjs-component :chart="$supplyChart" />
                  </div>
                </div>
              </div>
            </div>
